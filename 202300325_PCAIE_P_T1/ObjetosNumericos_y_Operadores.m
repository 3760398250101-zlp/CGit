...
disp("========================================");
disp("TIPOS DE OPERADORES");
disp("========================================");
printf("\n");


disp("1) OPERADORES ARITMÉTICOS");
...
disp("2) OPERADORES DE COMPARACIÓN");
...
t < r                         #verifica si t es menor que r
t <= r                        #verifica si t es menor o igual que r
t == r                        #verifica si t y r tienen el mismo valor
t > r                         #verifica si t es mayor que r
t >= r                        #verifica si t es mayor o igual que r
t != r                        #verifica si t es distinto de r

printf("\n");


disp("3) OPERADORES BOOLEANOS");
